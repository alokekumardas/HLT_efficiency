...
//   vector<bool>    *passFilterMu23_Ele12_legEle;
   vector<vector<string> > *filterName32;
   vector<vector<bool> > *filterDecision32;
...
//   TBranch        *b_passFilterMu23_Ele12_legEle;   //!
   TBranch        *b_filterName32;   //!
   TBranch        *b_filterDecision32; //!
...
//   fChain->SetBranchAddress("passFilterMu23_Ele12_legEle", &passFilterMu23_Ele12_legEle, &b_passFilterMu23_Ele12_legEle);
   fChain->SetBranchAddress("filterName32", &filterName32, &b_filterName32);
   fChain->SetBranchAddress("filterDecision32", &filterDecision32, &b_filterDecision32);
   Notify();
}
